...
void	initialization_struct(t_cub3d *cub, char **file_content,
			int i, int j);
...
int		read_texture_pixel(char *texture_data,
			int tex_x, int tex_y, int line_length);
...
int		get_wall_orientation(double ray_dir_x,
			double ray_dir_y, double hit_x, double hit_y);
